...
export const w001ConceptNotImplemented: Rule = {
  meta: {
    ...
    docs: {
      ...
      rationale:
        "A concept defined in arc42 section 8 only has value if at least one building-block explicitly implements it. An orphaned concept — declared but never referenced by any building-block via 'implements:' — is either dead documentation or a gap: the concern exists but nobody is responsible for it.",
      arc42Chapter: 8,
      recommended: true,
    },
  },
